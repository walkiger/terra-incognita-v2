...
* **Eine Änderung = ein Commit** (`Anweisungen.md` §5 *Effiziente
  Ausführung*).
...
| **Coverage ≥ 80 %** *(neue/geänderte Dateien)* | jeder Push        | CI                                |
...
| M0.6  | pre-commit-baseline               | —     | `chore/pre-commit-baseline`                | —   | [ ]    |       |
| M0.7  | github-actions-ci-baseline        | —     | `chore/github-actions-ci-baseline`         | —   | [ ]    |       |
| M0.8  | secrets-sops-baseline             | —     | `chore/secrets-sops-baseline`              | —   | [ ]    |       |
| M0.9  | logging-and-observability-baseline | —    | `feature/logging-observability-baseline`   | —   | [ ]    |       |
| M0.10 | branch-and-pr-rules-md            | —     | `docs/branch-and-pr-rules-md`              | —   | [ ]    |       |
