...
**Berührte Pfade:** `pyproject.toml`, `requirements*.txt` *(falls vorhanden, ablösen)*, `.python-version`, `app/engine/pyproject.toml` (separates Sub-Paket)
...
> Wird sukzessive gefüllt. Format: `[yyyy-mm-dd] M0.k slug — Kurz-Notiz (PR #NNN)`
