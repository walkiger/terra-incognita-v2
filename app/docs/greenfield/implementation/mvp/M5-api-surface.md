...
app/backend/main.py                          ← uvicorn entry point
...
app/backend/api/routers/version.py
app/backend/api/diagnostics/dep_status.py
...
```
app/backend/api/security/jwt.py
app/backend/api/routers/auth.py
app/backend/api/deps_auth.py
...
```
app/backend/api/security/passwords.py
app/backend/ti_hub/db/repos/users.py       ← Schreib-Helfer für `pwhash_argon2`
...
```
app/backend/api/security/refresh.py
app/backend/api/routers/auth.py                ← `/v1/auth/refresh`, `/v1/auth/logout`
app/backend/ti_hub/db/repos/refresh_tokens.py
app/backend/ti_hub/db/schema/0003_refresh_tokens.sql
...
```
app/backend/api/routers/encounters.py
app/backend/api/models/encounters_api.py
...
```
app/backend/api/routers/snapshots.py
...
```
app/backend/api/routers/replay.py
app/backend/api/models/replay_api.py            ← Pydantic, gegen replay_timeline_window_v4
...
```
app/backend/api/routers/diagnostic.py
app/backend/api/diagnostics/aggregator.py
...
```
app/backend/api/routers/admin.py
...
```
app/backend/api/ws/viewer.py
app/backend/api/ws/dispatch.py                  ← bereits vorhanden, erweitern
...
```
app/backend/api/ws/engine.py                  ← bereits vorhanden, hier finalisiert
...
```
app/backend/api/middleware/ratelimit.py
app/backend/api/quotas.py
...
app/backend/api/openapi_meta.py                 ← Metadata-Konfig
...
- **Chore (pre-M5.1)** API-Paket nach `app/backend/api/` verlegt; Bootstrap-Scaffold
  (`main.py`, `observability.py`) und `app/backend/main.py` als uvicorn-Einstieg
  erstellt. Docker-Build-Kontext auf Repo-Root umgestellt. — 2026-05-09

---

_Stand: 2026-05-09 · API-Bootstrap-Scaffold vorhanden; M5.1 (create_app-Factory) noch offen_
